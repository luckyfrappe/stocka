...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        if self.order_total < settings.FREE_DELIVERY_THRESHOLD and all(item.purchase_type not in [PurchaseType.BUYOUT, PurchaseType.EXTEND] for item in self.lineitems.all()):
